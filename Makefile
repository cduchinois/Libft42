...
SRC=ft_atoi.c ft_bzero.c ft_calloc.c ft_freetab.c ft_isalnum.c \
...
ft_striteri.c ft_strjoin.c ft_strlcat.c ft_strlcpy.c ft_strldup.c \
ft_strlen.c ft_strmapi.c ft_strncmp.c ft_strndup.c ft_strnstr.c \
ft_strrchr.c ft_strtrim.c ft_substr.c ft_tolower.c ft_toupper.c

BONUS_SRC=ft_listsize.c ft_lstadd_back.c ft_lstadd_front.c ft_lstclear.c \
